import{j as t,a}from"./app-DaPXRLEo.js";function s({links:r,additionalUrlParams:n=""}){return t.jsx(t.Fragment,{children:r.length>3&&t.jsx("nav",{className:"text-center mt-4",children:r.map(e=>t.jsx(a,{href:(e.url||"")+(n!==""?"&type="+n:""),onClick:()=>handleClick(e.url),className:`
