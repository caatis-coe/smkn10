...
function Edit({ auth, prestasiSiswa }) {

    const { data, setData, post, errors, reset } = useForm({
        achievement: prestasiSiswa.achievement || "",
        year: prestasiSiswa.year || "",
        _method: 'PUT'
    })

    const onSubmit = (e) => {
        e.preventDefault();
        post(route("prestasi-siswa-db.update", prestasiSiswa.id))
    }
            ...
            header={
                <div className='flex justify-between items-center'>
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                        Edit "{prestasiSiswa.achievement}" achievement, with id: {prestasiSiswa.id}
                    </h2>
                </div>
            }
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg text-gray-900">
                        ...
                        <form
                            ...
                            <div className='mt-4'>
                                <InputLabel htmlFor="prestasiSiswa_achievement" value="*Achievement" />
                                <TextAreaInput
                                    id="prestasiSiswa_achievement"
                                    type="text"
                                    name="achievement"
                            ...
                            <div className='mt-4'>
                                <InputLabel htmlFor="prestasiSiswa_year" value="*Year" />
                                <TextInput
                                    id="prestasiSiswa_year"
                                    type="number"
                                    name="year"
                                    value={data.year}
                                    className="mt-1 block w-full"
