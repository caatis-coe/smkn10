...
function Edit({ auth, prestasiSekolah }) {

    const { data, setData, post, errors, reset } = useForm({
        competition: prestasiSekolah.achievement || "",
        achievement: prestasiSekolah.result || "",
        _method: 'PUT'
    })

    const onSubmit = (e) => {
        e.preventDefault();
        post(route("prestasi-sekolah-db.update", prestasiSekolah.id))
    }
            ...
            header={
                <div className='flex justify-between items-center'>
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                        Edit "{prestasiSekolah.achievement}" competition, with id: {prestasiSekolah.id}
                    </h2>
                </div>
            }
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg text-gray-900">
                        ...
                        <form
                            ...
                            <div className='mt-4'>
                                <InputLabel htmlFor="prestasiSekolah_competition" value="*Competition" />
                                <TextInput
                                    id="prestasiSekolah_competition"
                                    type="text"
                                    name="competition"
                                ...
                                />
                                <InputError message={errors.competition} className='mt-2' />
                            </div>
                            <div className='mt-4'>
                            ...
                            <div className='mt-4 flex items-end justify-between'>
                                ...
                                <div className='mt-4 text-right'>
                                    <Link href={route("prestasi-sekolah-db.index")}
