...
function Edit({ auth, konsentrasiKeahlian,teachingFactoryProduct }) {

    const { data, setData, post, errors, reset } = useForm({
        image_path: null,
        title: teachingFactoryProduct.title || '',
        description: teachingFactoryProduct.description || '',
        konsentrasi_keahlian_id: teachingFactoryProduct.KonsentrasiKeahlianID || '',
        _method: 'PUT'
    })

    const onSubmit = (e) => {
        e.preventDefault();
        post(route("teaching-factory-product-db.update", teachingFactoryProduct.id));
    }
            ...
            header={
                <div className='flex justify-between items-center'>
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                        Edit "{teachingFactoryProduct.title}"
                    </h2>
                </div>
            }
        >
                        ...
                        <form
                            ...
                            <div className='mt-4'>
                                ...
                                <SelectInput
                                    ...
                                    value={data.konsentrasi_keahlian_id}
                                    className="mt-1 block w-full"
                                    onChange={(e) => {
                                        setData((prev) => (
                                            {
                                                ...prev,
                                                'konsentrasi_keahlian_id' : e.target.value
                                            }
                                        ));
                                    }}
                                >
                            ...
                            <div className='mt-4 flex items-end justify-between'>
                                ...
                                <div className=''>
                                    ...
                                    <Link href={route("teaching-factory-product-db.index",{ type: data.konsentrasi_keahlian_id })}
