                                        ...
                                        <tr key={index} className='bg-white border-b 
                                            ...
                                            <td className='px-3 py-2 overflow-hidden w-48'>
                                                <div className="relative w-full h-0 pb-[56.25%]"> {/* Aspect ratio container */}
                                                    <img
                                                        src={`images/${pembelajaran.image_path}`}
                                                        alt={`${pembelajaran.image_path}`}
                                                        className='absolute top-1/2 left-1/2 w-full h-full object-cover transform -translate-x-1/2 -translate-y-1/2'
                                                    />
                                                </div>
                                            </td>
                                            <td className='px-3 py-2'>{pembelajaran.title}</td>
                                            <td className='px-3 py-2'>{pembelajaran.description || <span className='text-gray-300'>None</span>}</td>
                                            ...
                                            <td className='px-3 py-2'>
                                                ...
                                                <Link href={route("pembelajaran-db.destroy", pembelajaran.id)}
