...
function Index({ auth, datas, success, session }) {
    ...
    const deleteBerita = (daftarTenagaPendidikan) => {
        ...
        router.delete(route("daftar-tenaga-pendidikan-db.destroy", daftarTenagaPendidikan.id))
    }
                                ...
                                <table className='w-full text-sm text-left rtl:text-right
                                    ...
                                    <thead className='text-xs text-gray-700 uppercase bg-gray-100
                                        ...
                                        <tr className='text-nowrap'>
                                            ...
                                            <th className='px-3 py-5'>NIK</th>
                                            <th className='px-3 py-5'>Position</th>
                                    ...
                                    <tbody>
                                        {datas.data.map((data, index) => (
                                            <tr key={index} className='bg-white border-b 
                                                border-gray-300'>
                                                <td className='px-3 py-4 text-nowrap'>{data.id}</td>
